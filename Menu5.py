...
class GestionBicicletas:
    ...
    def abrir_registro():
        ...
        ctk.CTkLabel(registro_win, text="Serial:").pack()
        ...
        ctk.CTkLabel(registro_win, text="Referencia:").pack()
        entrada_referencia = ctk.CTkEntry(registro_win)
        entrada_referencia.pack()

        ctk.CTkLabel(registro_win, text="Tamaño de la Llanta (decimal):").pack()
